...
f_5080:
    ...
    ; OP_PUSH_BUF
    sub     r12, 8
    mov     qword [r12], b_8639
    ; OP_CALL_FN
    call f_1216
    ; OP_PUSH_BUF
    sub     r12, 8
    mov     qword [r12], b_8640
    ; OP_CALL_FN
    call f_1216
    ; OP_PUSH_BUF
    sub     r12, 8
    mov     qword [r12], b_8641
    ; OP_CALL_FN
    call f_1216
    ; OP_CALL_FN
    call f_8087
    ; OP_PUSH_BUF
    sub     r12, 8
    mov     qword [r12], b_8642
    ; OP_CALL_FN
    call f_1171
    ; OP_PUSH_BUF
    sub     r12, 8
    mov     qword [r12], b_8643
    ; OP_CALL_FN
    call f_1216
    ; OP_PUSH_BUF
    sub     r12, 8
    mov     qword [r12], b_8644
    ; OP_CALL_FN
    call f_1216
    ; OP_PUSH_BUF
    sub     r12, 8
    ...
    ; OP_PUSH_BUF
    sub     r12, 8
    mov     qword [r12], b_8646
    ; OP_CALL_FN
    call f_1216
    ; OP_PUSH_BUF
    sub     r12, 8
    mov     qword [r12], b_8647
    ; OP_CALL_FN
    call f_1216
    ; OP_PUSH_BUF
    sub     r12, 8
...
section .data
    ...
    b_8215 db "'",10,0
    b_8216 db "Expected file name for 'use' directive",10,0
    ...
    b_8237 db "Invalid preprocessor directive",10,0
    b_8238 db "use",0
    b_8239 db "error",0
    b_8240 db "macro",0
    b_8241 db "flag",0
    b_8242 db "undef",0
    b_8243 db "ifdef",0
    b_8244 db "Expected macro name for 'if' directive",10,0
    b_8245 db "Expected braces for 'if' directive",10,0
    b_8246 db "ifndef",0
    b_8247 db "Expected macro name for 'if' directive",10,0
    b_8248 db "Expected braces for 'if' directive",10,0
    b_8249 db "Unknown preprocessor directive '",0
    b_8250 db "'",10,0
    b_8251 db "Buffer '",0
    b_8252 db "' already defined",10,0
    b_8253 db "Struct '",0
    b_8254 db "' already defined",10,0
    b_8255 db "Enum '",0
    b_8256 db "' already defined",10,0
    b_8257 db "Function '",0
    b_8258 db "' already defined",10,0
    b_8259 db "Unrecognized struct '",0
    b_8260 db "'",10,0
    b_8261 db "Expected field access after '->",0
    b_8262 db "'",10,0
    b_8263 db "Field '",0
    b_8264 db "' not found for struct '",0
    b_8265 db "'",10,0
    b_8266 db "Buffer '",0
    b_8267 db "' not defined in this scope",10,0
    b_8268 db "Invalid struct name after '->'",10,0
    b_8269 db "storec",0
    b_8270 db "Function 'storec' not defined",10,0
    b_8271 db "storec",0
    b_8272 db "fetchc",0
    b_8273 db "Function 'fetchc' not defined",10,0
    b_8274 db "fetchc",0
    b_8275 db "__OP_NOOP",0
    b_8276 db "__OP_EXIT",0
    b_8277 db "__OP_RET",0
    b_8278 db "__OP_DROP",0
    b_8279 db "__OP_PICK",0
    b_8280 db "__OP_ROLL",0
    b_8281 db "__OP_DEPTH",0
    b_8282 db "__OP_STORE",0
    b_8283 db "__OP_FETCH",0
    b_8284 db "__OP_ADD",0
    b_8285 db "__OP_SUB",0
    b_8286 db "__OP_MUL",0
    b_8287 db "__OP_DIV",0
    b_8288 db "__OP_AND",0
    b_8289 db "__OP_OR",0
    b_8290 db "__OP_XOR",0
    b_8291 db "__OP_SHL",0
    b_8292 db "__OP_SHR",0
    b_8293 db "__OP_SAR",0
    b_8294 db "__OP_NOT",0
    b_8295 db "__OP_EQ",0
    b_8296 db "__OP_GT",0
    b_8297 db "__OP_LT",0
    b_8298 db "__OP_FOPEN",0
    b_8299 db "__OP_FREAD",0
    b_8300 db "__OP_FWRITE",0
    b_8301 db "__OP_FCLOSE",0
    b_8302 db "Expected variant after '",0
    b_8303 db "'",10,0
    b_8304 db "Field '",0
    b_8305 db "' not found for enum '",0
    b_8306 db "'",10,0
    b_8307 db "Buffer '",0
    b_8308 db "' (",0
    b_8309 db " bytes) cannot be automatically read from",10,0
    b_8310 db "Invalid 'if' condition",10,0
    b_8311 db "Function '",0
    b_8312 db "' already defined",10,0
    b_8313 db "Function '",0
    b_8314 db "' must be defined in global scope",10,0
    b_8315 db "Invalid buffer size",10,0
    b_8316 db "Type '",0
    b_8317 db "' not found",10,0
    b_8318 db "Invalid buffer size",10,0
    b_8319 db "Invalid buffer size",10,0
    b_8320 db "Invalid buffer size",10,0
    b_8321 db "Buffers defined at global scope must be static",10,0
    b_8322 db "Invalid buffer name",10,0
    b_8323 db "Invalid size for buffer '",0
    b_8324 db "'",10,0
    b_8325 db "Invalid size for buffer '",0
    b_8326 db "'",10,0
    b_8327 db "Invalid size for buffer '",0
    b_8328 db "'",10,0
    b_8329 db "Invalid initialization value for buffer '",0
    b_8330 db "'",10,0
    b_8331 db "Buffer '",0
    b_8332 db "' (",0
    b_8333 db " bytes) cannot be automatically assigned to",10,0
    b_8334 db "Non-static buffers can only utilize block initialization",10,0
    b_8335 db "Invalid definition for buffer '",0
    b_8336 db "'",10,0
    b_8337 db "Buffer '",0
    b_8338 db "' cannot exceed ",0
    b_8339 db " bytes",10,0
    b_8340 db "Buffer '",0
    b_8341 db "' not defined in this scope",10,0
    b_8342 db "Buffer '",0
    b_8343 db "' (",0
    b_8344 db " bytes) cannot be automatically assigned to",10,0
    b_8345 db "Invalid enum name",10,0
    b_8346 db "Enum '",0
    b_8347 db "' must be defined in global scope",10,0
    b_8348 db "Invalid enum definition",10,0
    b_8349 db "Invalid variant for enum '",0
    b_8350 db "'",10,0
    b_8351 db "Variant '",0
    b_8352 db "' already defined for enum '",0
    b_8353 db "'",10,0
    b_8354 db "Invalid value for enum variant '",0
    b_8355 db "'",10,0
    b_8356 db "Enum '",0
    b_8357 db "' must have values in ascending order",10,0
    b_8358 db "Invalid struct name",10,0
    b_8359 db "Struct '",0
    b_8360 db "' must be defined in global scope",10,0
    b_8361 db "Invalid struct definition",10,0
    b_8362 db "Invalid field for struct '",0
    b_8363 db "'",10,0
    b_8364 db "Field '",0
    b_8365 db "' already defined for struct '",0
    b_8366 db "'",10,0
    b_8367 db "Invalid struct name after '->'",10,0
    b_8368 db "Buffer '",0
    b_8369 db "' not defined",10,0
    b_8370 db "Unexpected preprocessing directive",10,0
    b_8371 db "Macro '",0
    b_8372 db "' not defined",10,0
    b_8373 db "Unexpected token of type ",0
    b_8374 db "Unexpected token of type ",0
    b_8375 db " outside of 'main'",10,0
    b_8376 db "main",0
    b_8377 db "Function 'main' not defined",10,0
    b_8378 db "main",0
    b_8379 db "ERROR: Failed to write string to output file",10,0
    b_8380 db "ERROR: Failed to write integer to output file",10,0
    b_8381 db "ERROR: Failed to write character to output file",10,0
    b_8382 db "    sub     ",0
    b_8383 db ", 8",10,0
    b_8384 db "    mov     qword [",0
    b_8385 db "], ",0
    b_8386 db 10,0
    b_8387 db "    sub     ",0
    b_8388 db ", 8",10,0
    b_8389 db "    mov     qword [",0
    b_8390 db "], ",0
    b_8391 db 10,0
    b_8392 db "    add     ",0
    b_8393 db ", 8",10,0
    ...
    b_8399 db "f_",0
    b_8400 db ":",10,0
    b_8401 db "    push    rbp",10,0
    b_8402 db "    mov     rbp, rsp",10,0
    b_8403 db "    ; ",0
    b_8404 db 10,0
    b_8405 db "rcx",0
    b_8406 db "rax",0
    ...
    b_8409 db 10,0
    b_8410 db "rax",0
    b_8411 db "    ; OP_EXIT",10,0
    b_8412 db "rdi",0
    b_8413 db "    mov     eax, 60",10,0
    b_8414 db "    syscall",10,0
    b_8415 db "    ; OP_CALL",10,0
    b_8416 db "rax",0
    b_8417 db "    call rax",10,0
    b_8418 db "    ; OP_PUSH_FN",10,0
    b_8419 db "    lea rax, [rel f_",0
    b_8420 db "]",10,0
    b_8421 db "rax",0
    b_8422 db "    ; OP_CALL_FN",10,0
    b_8423 db "    call f_",0
    b_8424 db 10,0
    b_8425 db "    ; OP_RET",10,0
    b_8426 db "    leave",10,0
    b_8427 db "    ret",10,0
    b_8428 db "    ; OP_PUSH_INT",10,0
    b_8429 db "    ; OP_DROP",10,0
    b_8430 db "    ; OP_PICK",10,0
    b_8431 db "rax",0
    b_8432 db "    mov     rcx, [",0
    b_8433 db " + rax*8]",10,0
    b_8434 db "rcx",0
    b_8435 db "    ; OP_ROLL",10,0
    b_8436 db "rax",0
    b_8437 db "    mov     rcx, [",0
    b_8438 db " + rax*8]",10,0
    b_8439 db "    lea     rbx, [",0
    b_8440 db " + rax*8]",10,0
    b_8441 db "    .rl_",0
    b_8442 db ":",10,0
    b_8443 db "    cmp     rbx, ",0
    b_8444 db 10,0
    b_8445 db "    je      .rl_",0
    b_8446 db 10,0
    b_8447 db "    mov     rdx, [rbx - 8]",10,0
    b_8448 db "    mov     [rbx], rdx",10,0
    b_8449 db "    sub     rbx, 8",10,0
    b_8450 db "    jmp     .rl_",0
    b_8451 db 10,0
    b_8452 db "    .rl_",0
    b_8453 db ":",10,0
    ...
    b_8457 db "    mov     rax, b_stack + ",0
    b_8458 db 10,0
    b_8459 db "    sub     rax, ",0
    b_8460 db 10,0
    b_8461 db "    shr     rax, 3",10,0
    b_8462 db "rax",0
    b_8463 db "    ; OP_PUSH_BUF",10,0
    b_8464 db "    sub     ",0
    b_8465 db ", 8",10,0
    b_8466 db "    mov     qword [",0
    b_8467 db "], ",0
    b_8468 db "b_",0
    b_8469 db 10,0
    b_8470 db "    ; OP_STORE",10,0
    b_8471 db "rax",0
    b_8472 db "rcx",0
    b_8473 db "    mov     [rax], rcx",10,0
    b_8474 db "    ; OP_FETCH",10,0
    b_8475 db "rax",0
    b_8476 db "    mov     rbx, qword [rax]",10,0
    b_8477 db "rbx",0
    b_8478 db "    ; OP_PUSH_VAR",10,0
    b_8479 db "    lea     rax, [rbp - ",0
    b_8480 db "]",10,0
    b_8481 db "rax",0
    b_8482 db "    ; OP_ALLOC",10,0
    b_8483 db "    sub     rsp, ",0
    b_8484 db 10,0
    b_8485 db "rcx",0
    b_8486 db "add",0
    ...
    b_8492 db "imul",0
    b_8493 db "OP_MUL",0
    b_8494 db "    ; OP_DIV",10,0
    b_8495 db "rbx",0
    b_8496 db "rax",0
    b_8497 db "    cqo",10,0
    b_8498 db "    idiv    rbx",10,0
    b_8499 db "rax",0
    b_8500 db "rcx",0
    b_8501 db "and",0
    b_8502 db "OP_AND",0
    ...
    b_8516 db "sar",0
    b_8517 db "OP_SAR",0
    b_8518 db "    ; OP_NOT",10,0
    b_8519 db "rax",0
    b_8520 db "    not     rax",10,0
    b_8521 db "rax",0
    b_8522 db "    ; OP_EQ",10,0
    b_8523 db "rbx",0
    b_8524 db "rax",0
    b_8525 db "    cmp     rax, rbx",10,0
    b_8526 db "    sete    al",10,0
    b_8527 db "    movzx   rax, al",10,0
    b_8528 db "rax",0
    b_8529 db "    ; OP_GT",10,0
    b_8530 db "rbx",0
    b_8531 db "rax",0
    b_8532 db "    cmp     rax, rbx",10,0
    b_8533 db "    setg    al",10,0
    b_8534 db "    movzx   rax, al",10,0
    b_8535 db "rax",0
    b_8536 db "    ; OP_LT",10,0
    b_8537 db "rbx",0
    b_8538 db "rax",0
    b_8539 db "    cmp     rax, rbx",10,0
    b_8540 db "    setl    al",10,0
    b_8541 db "    movzx   rax, al",10,0
    b_8542 db "rax",0
    b_8543 db ".l_",0
    b_8544 db ":",10,0
    b_8545 db "    ; OP_JMP",10,0
    b_8546 db "    jmp     .l_",0
    b_8547 db 10,0
    b_8548 db "    ; OP_JZ",10,0
    b_8549 db "rax",0
    b_8550 db "    test    rax, rax",10,0
    b_8551 db "    jz     .l_",0
    b_8552 db 10,0
    b_8553 db "    ; OP_FOPEN",10,0
    b_8554 db "rsi",0
    b_8555 db "rdi",0
    b_8556 db "    mov     rax, 2",10,0
    b_8557 db "    cmp     rsi, 0",10,0
    b_8558 db "    je      .frl_",0
    b_8559 db 10,0
    b_8560 db "    cmp     rsi, 1",10,0
    b_8561 db "    je      .fwl_",0
    b_8562 db 10,0
    b_8563 db "    cmp     rsi, 2",10,0
    b_8564 db "    je      .fal_",0
    b_8565 db 10,0
    b_8566 db "    jmp     .ffl_",0
    b_8567 db 10,0
    b_8568 db "    .frl_",0
    b_8569 db ":",10,0
    b_8570 db "    mov     rsi, 0",10,0
    b_8571 db "    jmp     .fdl_",0
    b_8572 db 10,0
    b_8573 db "    .fwl_",0
    b_8574 db ":",10,0
    b_8575 db "    mov     rsi, 577",10,0
    b_8576 db "    jmp     .fdl_",0
    b_8577 db 10,0
    b_8578 db "    .fal_",0
    b_8579 db ":",10,0
    b_8580 db "    mov     rsi, 1025",10,0
    b_8581 db "    jmp     .fdl_",0
    b_8582 db 10,0
    b_8583 db "    .fdl_",0
    b_8584 db ":",10,0
    b_8585 db "    mov     rdx, 420",10,0
    b_8586 db "    syscall",10,0
    b_8587 db "rax",0
    b_8588 db "    jmp     .fel_",0
    b_8589 db 10,0
    b_8590 db "    .ffl_",0
    b_8591 db ":",10,0
    b_8592 db "    mov     rax, -1",10,0
    b_8593 db "rax",0
    b_8594 db "    .fel_",0
    b_8595 db ":",10,0
    b_8596 db "    ; OP_FREAD",10,0
    b_8597 db "rdi",0
    b_8598 db "rdx",0
    b_8599 db "rsi",0
    b_8600 db "    mov     rax, 0",10,0
    b_8601 db "    syscall",10,0
    b_8602 db "rax",0
    b_8603 db "    ; OP_FWRITE",10,0
    b_8604 db "rdi",0
    b_8605 db "rdx",0
    b_8606 db "rsi",0
    b_8607 db "    mov     rax, 1",10,0
    b_8608 db "    syscall",10,0
    b_8609 db "rax",0
    b_8610 db "    ; OP_FCLOSE",10,0
    b_8611 db "rdi",0
    b_8612 db "    mov     rax, 3",10,0
    b_8613 db "    syscall",10,0
    b_8614 db "rax",0
    b_8615 db "ERROR: Invalid opcode of type ",0
    b_8616 db 34,0
    b_8617 db 34,",",0
    b_8618 db ",",0
    b_8619 db 34,",",0
    b_8620 db "0",10,0
    b_8621 db "    ; Inline Buffers",10,0
    b_8622 db "    b_",0
    b_8623 db " db ",0
    b_8624 db "    ; ",0
    b_8625 db 10,0
    ...
    b_8637 db " ; ",0
    b_8638 db 10,0
    b_8639 db "BITS 64",10,0
    b_8640 db "global _start",10,0
    b_8641 db "section .text",10,0
    b_8642 db "; start",10,0
    b_8643 db "_start:",10,0
    b_8644 db "    lea     ",0
    b_8645 db ", [b_stack + ",0
    b_8646 db "]",10,0
    b_8647 db "    lea     rdi, [rsp + 8]",10,0
    b_8648 db "rdi",0
    b_8649 db "    mov     rdi, [rsp]",10,0
    b_8650 db "rdi",0
    b_8651 db "section .data",10,0
    b_8652 db "section .bss",10,0
    b_8653 db "    b_stack: resb ",0
    b_8654 db 10,0
    b_8655 db "Example:",10,0
    b_8656 db 9,0
    b_8657 db " ./src/main.4c ./target/output.asm x86_64-linux",0
    b_8658 db "ERROR: Invalid target '",0
    b_8659 db "'. Expected <architecture>-<OS>.",10,0
    b_8660 db "x86_64",0
    b_8661 db "x64",0
    b_8662 db "ARCH_X86_64",0
    b_8663 db "ERROR: Unrecognized architecture '",0
    b_8664 db "'",10,0
    b_8665 db "linux",0
    b_8666 db "OS_LINUX",0
    b_8667 db "windows",0
    b_8668 db "OS_WINDOWS",0
    b_8669 db "ERROR: Unrecognized OS '",0
    b_8670 db "'",10,0
    b_8671 db "--debug",0
    b_8672 db "-d",0
    b_8673 db "--std",0
    b_8674 db "ERROR: Unrecognized option '",0
    b_8675 db "'",10,0
    b_8676 db "Options:",10,0
    b_8677 db 9,"-d, --debug",9,9,"compile with debug information",0
    b_8678 db "Usage: ",0
    b_8679 db " <source_file> <output_file> <platform> [options]",10,0
    b_8680 db "./std/",0
    b_8681 db "./src/",0
    b_8682 db "./",0
    b_8683 db 0
    b_8684 db "ERROR: File '",0
    b_8685 db "' not found",10,0
    b_8686 db "WARNING: Compilation completed with a stack depth of ",0
    b_8687 db 10,0
section .bss
