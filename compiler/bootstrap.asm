...
section .data
    ...
    b_8285 db "' not defined in this scope",10,0
    b_8286 db "storec",0
    b_8287 db "ERROR: Function 'storec' not defined",10,0
    b_8288 db "ERROR: Buffer '",0
    b_8289 db "' cannot be automatically assigned to",10,0
    b_8290 db "ERROR: Buffer '",0
    b_8291 db "' not defined in this scope",10,0
    b_8292 db "ERROR: Unexpected preprocessing directive",10,0
    b_8293 db "ERROR: Macro '",0
    b_8294 db "' not defined",10,0
    b_8295 db "ERROR: Unexpected token of type ",0
    b_8296 db "ERROR: Unexpected token of type ",0
    b_8297 db " outside of 'main'",10,0
    b_8298 db "main",0
    b_8299 db "ERROR: Function 'main' not defined",10,0
    b_8300 db "ERROR: Failed to write string to output file",10,0
    b_8301 db "ERROR: Failed to write integer to output file",10,0
    b_8302 db "ERROR: Failed to write character to output file",10,0
    b_8303 db "    sub     ",0
    b_8304 db ", 8",10,0
    b_8305 db "    mov     qword [",0
    b_8306 db "], ",0
    b_8307 db 10,0
    b_8308 db "    sub     ",0
    b_8309 db ", 8",10,0
    b_8310 db "    mov     qword [",0
    b_8311 db "], ",0
    b_8312 db 10,0
    b_8313 db "    add     ",0
    b_8314 db ", 8",10,0
    ...
    b_8328 db 10,0
    b_8329 db "rax",0
    b_8330 db "    ; OP_EXIT",10,0
    b_8331 db "rdi",0
    b_8332 db "    mov     eax, 60",10,0
    b_8333 db "    syscall",10,0
    b_8334 db "    ; OP_CALL",10,0
    b_8335 db "    call f_",0
    b_8336 db 10,0
    b_8337 db "    ; OP_RET",10,0
    b_8338 db "    ret",10,0
    b_8339 db "    ; OP_DROP",10,0
    b_8340 db "    ; OP_PICK",10,0
    b_8341 db "rax",0
    b_8342 db "    mov     rcx, [",0
    b_8343 db " + rax*8]",10,0
    b_8344 db "rcx",0
    b_8345 db "    ; OP_ROLL",10,0
    b_8346 db "rax",0
    b_8347 db "    mov     rcx, [",0
    b_8348 db " + rax*8]",10,0
    b_8349 db "    lea     rbx, [",0
    b_8350 db " + rax*8]",10,0
    b_8351 db "   .rl_",0
    b_8352 db ":",10,0
    b_8353 db "    cmp     rbx, ",0
    b_8354 db 10,0
    b_8355 db "    je      .rl_",0
    b_8356 db 10,0
    b_8357 db "    mov     rdx, [rbx - 8]",10,0
    b_8358 db "    mov     [rbx], rdx",10,0
    b_8359 db "    sub     rbx, 8",10,0
    b_8360 db "    jmp     .rl_",0
    b_8361 db 10,0
    b_8362 db "   .rl_",0
    b_8363 db ":",10,0
    b_8364 db "    mov     [",0
    b_8365 db "], rcx",10,0
    b_8366 db "    ; OP_DEPTH",10,0
    b_8367 db "    mov     rax, b_stack + ",0
    b_8368 db 10,0
    b_8369 db "    sub     rax, ",0
    b_8370 db 10,0
    b_8371 db "    shr     rax, 3",10,0
    b_8372 db "rax",0
    b_8373 db "    ; OP_PUSH_INT",10,0
    b_8374 db "    ; OP_PUSH_BUF",10,0
    b_8375 db "    sub     ",0
    b_8376 db ", 8",10,0
    b_8377 db "    mov     qword [",0
    b_8378 db "], ",0
    b_8379 db "b_",0
    b_8380 db 10,0
    b_8381 db "    ; OP_STORE",10,0
    b_8382 db "rax",0
    b_8383 db "rcx",0
    b_8384 db "    mov     [rax], rcx",10,0
    b_8385 db "    ; OP_FETCH",10,0
    b_8386 db "rax",0
    b_8387 db "    mov     rbx, qword [rax]",10,0
    b_8388 db "rbx",0
    b_8389 db "rcx",0
    b_8390 db "add",0
    b_8391 db "OP_ADD",0
    ...
    b_8396 db "imul",0
    b_8397 db "OP_MUL",0
    b_8398 db "    ; OP_DIV",10,0
    b_8399 db "rbx",0
    b_8400 db "rax",0
    b_8401 db "    cqo",10,0
    b_8402 db "    idiv    rbx",10,0
    b_8403 db "rax",0
    b_8404 db "rcx",0
    b_8405 db "and",0
    b_8406 db "OP_AND",0
    ...
    b_8420 db "sar",0
    b_8421 db "OP_SAR",0
    b_8422 db "    ; OP_NOT",10,0
    b_8423 db "rax",0
    b_8424 db "    not     rax",10,0
    b_8425 db "rax",0
    b_8426 db "    ; OP_EQ",10,0
    b_8427 db "rbx",0
    b_8428 db "rax",0
    b_8429 db "    cmp     rax, rbx",10,0
    b_8430 db "    sete    al",10,0
    b_8431 db "    movzx   rax, al",10,0
    b_8432 db "rax",0
    b_8433 db "    ; OP_GT",10,0
    b_8434 db "rbx",0
    b_8435 db "rax",0
    b_8436 db "    cmp     rax, rbx",10,0
    b_8437 db "    setg    al",10,0
    b_8438 db "    movzx   rax, al",10,0
    b_8439 db "rax",0
    b_8440 db "    ; OP_LT",10,0
    b_8441 db "rbx",0
    b_8442 db "rax",0
    b_8443 db "    cmp     rax, rbx",10,0
    b_8444 db "    setl    al",10,0
    b_8445 db "    movzx   rax, al",10,0
    b_8446 db "rax",0
    b_8447 db ".l_",0
    b_8448 db ":",10,0
    b_8449 db "    ; OP_JMP",10,0
    b_8450 db "    jmp     .l_",0
    b_8451 db 10,0
    b_8452 db "    ; OP_JZ",10,0
    b_8453 db "rax",0
    b_8454 db "    test    rax, rax",10,0
    b_8455 db "    jz     .l_",0
    b_8456 db 10,0
    b_8457 db "    ; OP_FOPEN",10,0
    b_8458 db "rsi",0
    b_8459 db "rdi",0
    b_8460 db "    mov     rax, 2",10,0
    b_8461 db "    cmp     rsi, 0",10,0
    b_8462 db "    je      .frl_",0
    b_8463 db 10,0
    b_8464 db "    cmp     rsi, 1",10,0
    b_8465 db "    je      .fwl_",0
    b_8466 db 10,0
    b_8467 db "    cmp     rsi, 2",10,0
    b_8468 db "    je      .fal_",0
    b_8469 db 10,0
    b_8470 db "    jmp     .ffl_",0
    b_8471 db 10,0
    b_8472 db "    .frl_",0
    b_8473 db ":",10,0
    b_8474 db "    mov     rsi, 0",10,0
    b_8475 db "    jmp     .fdl_",0
    b_8476 db 10,0
    b_8477 db "    .fwl_",0
    b_8478 db ":",10,0
    b_8479 db "    mov     rsi, 577",10,0
    b_8480 db "    jmp     .fdl_",0
    b_8481 db 10,0
    b_8482 db "    .fal_",0
    b_8483 db ":",10,0
    b_8484 db "    mov     rsi, 1025",10,0
    b_8485 db "    jmp     .fdl_",0
    b_8486 db 10,0
    b_8487 db "    .fdl_",0
    b_8488 db ":",10,0
    b_8489 db "    mov     rdx, 420",10,0
    b_8490 db "    syscall",10,0
    b_8491 db "rax",0
    b_8492 db "    jmp     .fel_",0
    b_8493 db 10,0
    b_8494 db "    .ffl_",0
    b_8495 db ":",10,0
    b_8496 db "    mov     rax, -1",10,0
    b_8497 db "rax",0
    b_8498 db "    .fel_",0
    b_8499 db ":",10,0
    b_8500 db "    ; OP_FREAD",10,0
    b_8501 db "rdi",0
    b_8502 db "rdx",0
    b_8503 db "rsi",0
    b_8504 db "    mov     rax, 0",10,0
    b_8505 db "    syscall",10,0
    b_8506 db "rax",0
    b_8507 db "    ; OP_FWRITE",10,0
    b_8508 db "rdi",0
    b_8509 db "rdx",0
    b_8510 db "rsi",0
    b_8511 db "    mov     rax, 1",10,0
    b_8512 db "    syscall",10,0
    b_8513 db "rax",0
    b_8514 db "    ; OP_FCLOSE",10,0
    b_8515 db "rdi",0
    b_8516 db "    mov     rax, 3",10,0
    b_8517 db "    syscall",10,0
    b_8518 db "rax",0
    b_8519 db "ERROR: Invalid opcode of type ",0
    b_8520 db 34,",",0
    b_8521 db ",",0
    b_8522 db 34,",",0
    b_8523 db "0",10,0
    b_8524 db "    ; Inline Buffers",10,0
    b_8525 db "    b_",0
    b_8526 db " db ",0
    b_8527 db "    ; ",0
    b_8528 db 10,0
    ...
    b_8540 db " ; ",0
    b_8541 db 10,0
    b_8542 db "BITS 64",10,0
    b_8543 db "global _start",10,0
    b_8544 db "section .text",10,0
    b_8545 db "; start",10,0
    b_8546 db "_start:",10,0
    b_8547 db "    lea     ",0
    b_8548 db ", [b_stack + ",0
    b_8549 db "]",10,0
    b_8550 db "    lea     rdi, [rsp + 8]",10,0
    b_8551 db "rdi",0
    b_8552 db "    mov     rdi, [rsp]",10,0
    b_8553 db "rdi",0
    b_8554 db "section .data",10,0
    b_8555 db "section .bss",10,0
    b_8556 db "    b_stack: resb ",0
    b_8557 db " ; Stack Pointer",10,0
    b_8558 db "Usage: ",0
    b_8559 db " <source_file> <output_file>",10,0
    b_8560 db "ERROR: File '",0
    b_8561 db "' not found",10,0
section .bss
