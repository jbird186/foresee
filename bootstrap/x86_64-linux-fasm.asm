...
section '.rodata'
    ...
    b_8318 db "    mov     word [rax], cx",10,0
    b_8325 db "    jg      .csl_",0
    ...
    b_9044 db "Usage: ",0
    b_9053 db "    movzx   rax, byte [rax]",10,0
    b_9060 db ".quad ",0
    ...
    b_10135 db " // ",0
    b_10161 db "switch",0
    b_10173 db "    mov     dword [rax], ecx",10,0
    b_10179 db "-=",0
    b_10188 db "    ldr     x0, =",0
    b_10235 db ":",10,0
    ...
    b_13023 db "    b       .l_",0
    b_13024 db "OP_NE",0
    b_13034 db "    mov     eax, dword [rax]",10,0
    ...
    b_13177 db "var",0
    b_13180 db "    jmp     .l_",0
    b_13190 db "    mov     byte [rax], cl",10,0
    ...
    b_15522 db "    movzx   rax, word [rax]",10,0
