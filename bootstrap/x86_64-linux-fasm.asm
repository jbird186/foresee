...
.l_288_2:
    ...
    call    f_7332
    mov     rcx, qword [r12]
    mov     qword [b_1949], rcx
    add     r12, 8
    call    f_7175
    mov     rax, qword [b_1949]
    mov     qword [r12 - 8], rax
    sub     r12, 8
    call    f_2890
    add     r12, 8
...
.l_2126_2:
    ...
    mov     qword [r12 - 8], rax
    mov     rcx, qword [r12 - 8]
    mov     qword [b_1195], rcx
    movzx   rax, byte [b_4816]
    test    rax, rax
    jz      .l_2126_9
    lea     rax, [b_9874]
    mov     qword [r12 - 8], rax
...
.l_2870_6:
    ...
    mov     qword [r12], 0
    mov     rcx, qword [r12]
    mov     qword [b_6266], rcx
    mov     qword [r12], 0
    mov     rcx, qword [r12]
    mov     qword [b_1210], rcx
    mov     qword [r12], 0
    mov     rcx, qword [r12]
    mov     qword [b_3364], rcx
    mov     qword [r12], 0
    mov     qword [r12 - 8], 21
    lea     rax, [b_7064]
    mov     qword [r12 - 16], rax
...
f_3028:
    ...
    sub     rsp, 8
    mov     rcx, qword [r12]
    mov     qword [b_4722], rcx
    mov     qword [r12], 1
    mov     rcx, qword [r12]
    mov     qword [b_1082], rcx
    add     r12, 8
.l_3028_0:
    call    f_3838
    mov     rax, qword [r12]
...
.l_3028_3:
    ...
    mov     qword [r12 - 8], 0
    mov     qword [r12 - 16], 6
    mov     rax, qword [b_4722]
    mov     qword [r12 - 24], rax
    mov     rax, qword [b_1082]
    mov     qword [r12 - 32], rax
    lea     rax, [b_2158]
    mov     qword [r12 - 40], rax
    sub     r12, 40
...
f_5822:
    ...
    mov     rbp, rsp
    mov     rcx, qword [r12]
    mov     qword [b_5161], rcx
    mov     rcx, qword [r12 + 8]
    mov     qword [b_6062], rcx
    mov     rax, qword [b_5161]
    mov     qword [r12 + 8], rax
    mov     rax, 4
    mov     rbx, qword [r12 + 8]
    cmp     rbx, rax
